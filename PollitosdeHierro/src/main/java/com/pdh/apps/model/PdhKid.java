...
public class PdhKid implements Serializable {
    ...
    @Temporal(TemporalType.TIMESTAMP)
    private Date pdhKidLastBasketReceived;
    ...
    public Date getPdhKidLastBasketReceived() {
        return pdhKidLastBasketReceived;
    }

    public void setPdhKidLastBasketReceived(Date pdhKidLastBasketReceived) {
    ...
    public String toString() {
        return "com.pdh.apps.model.PdhKid[ pdhKidId=" + pdhKidId + " ]";
    }
