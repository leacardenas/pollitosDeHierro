...
public class PdhHeadquarter implements Serializable {
    ...
    private String pdhHeadquarterUpdatedDate;
    ...
    public String getPdhHeadquarterUpdatedDate() {
        return pdhHeadquarterUpdatedDate;
    }

    public void setPdhHeadquarterUpdatedDate(String pdhHeadquarterUpdatedDate) {
    ...
    public String toString() {
        return "com.pdh.pollitosdehierroapp.entity.PdhHeadquarter[ pdhHeadquarterId=" + pdhHeadquarterId + " ]";
    }
